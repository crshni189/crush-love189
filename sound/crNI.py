...
def score_display(game_state):
    if game_state == 'main_game':   
        score_surfake = game_font.render(str(int(score)),True,(255,255,255))
...
pygame.init()
screen= pygame.display.set_mode((433,668))
pygame.display.set_caption('HELLO CRUSH!')
icon=pygame.image.load('assets/flappy.ico').convert_alpha()
